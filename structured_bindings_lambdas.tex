...
bindings initializations - with a compiler concept that determines if a type
is \texttt{x-decomposable}
...
free \texttt{get<>()} method/function
...
available as of C++17.  And as such a concept provided by the compiler is
required.
...
cardinality of the structured bindings decomposition
