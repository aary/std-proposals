...
Given the above expansions, a polymorphic lambda behaves identically to a
...
propagate from within the lambda, so if a function level try catch block was
allowed for a lambda that would catch an exception that was generated during
the "decomposition" process.


\section{Acknowledgements}

Thanks to Eric Niebler for the suggestions and the help with this paper!
